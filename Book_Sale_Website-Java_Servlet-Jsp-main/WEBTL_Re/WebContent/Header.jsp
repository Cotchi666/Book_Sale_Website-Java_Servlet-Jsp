					...
					<ul class="header__top-list">
						...
						<c:if test="${sessionScope.acc.isAdmin == 1  }">
							<li class="header__top-item"><a class="header__top-link"
								href="mngAccount">Manager Account</a></li>
						</c:if>
						...
						<c:if test="${sessionScope.acc.isAdmin == 1}">
							<li class="header__top-item"><a class="header__top-link"
								href="mngOrder">Manager Order</a></li>
						</c:if>
	...
	<div class="header__bottom">
		<div class="container">
			<form action="search" method="post">
				<section class="row">
					...
					<div class="col-lg-6 col-md-7 col-sm-0 header__search">
						...
						</select> <input value="${txtS}" name="txt" type="text"
			...
			if (ss.getAttribute("cart") != null) {
				...
				map = (Map<String, OrderDetail>) ss.getAttribute("cart");
				number = map.size();
			}
			%>
			<a href="Cart.jsp" class="col-lg-1 col-md-1 col-sm-0 header__cart">
				<div class="header__cart-icon-wrap">
					<span class="header__notice"><%= number%></span> <i
